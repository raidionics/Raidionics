...
class AtlasVolume:
    ...
    @TODO2. Must include a parent_mri_uid, similar to what has been done for the Annotations.
    """
    ...
    def __init__(self, uid: str, input_filename: str, output_patient_folder: str, description_filename: str,
