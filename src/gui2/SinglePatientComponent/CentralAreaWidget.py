...
from src.gui2.SinglePatientComponent.CentralDisplayArea.CentralDisplayAreaWidget import CentralDisplayAreaWidget
from src.gui2.SinglePatientComponent.CentralAreaExecutionWidget import CentralAreaExecutionWidget
