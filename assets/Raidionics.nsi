...
!define INSTALLER_NAME "Raidionics-1.1.0-win.exe"
...
!include 'MUI.nsh'
!define MUI_ICON "..\src\images\raidionics-logo.ico"
...
WriteRegStr ${REG_ROOT} "${UNINSTALL_PATH}"  "DisplayIcon" "$INSTDIR\src\images\raidionics-logo.ico"
