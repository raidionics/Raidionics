...
hidden_imports = [x.split("=")[0] for x in hidden_imports] + ["raidionicsrads", "raidionicsseg", "ants", "sklearn",
"scikit-learn", "statsmodels", "gevent", "distutils", "PySide6", "gdown", "pydicom", "rt_utils"]
