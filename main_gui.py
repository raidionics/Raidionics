...
class MainWindow(QMainWindow):
    ...
    def __set_layouts2(self):
        ...
        self.overall_hbox.addStretch(1)
        self.overall_hbox.addLayout(self.main_vbox)
        self.overall_hbox.addStretch(1)
        self.overall_hbox.addWidget(self.display_area_widget)
        self.overall_hbox.addStretch(1)

        self.central_label = QLabel()
        self.central_label.setLayout(self.overall_hbox)
        self.setCentralWidget(self.central_label)
